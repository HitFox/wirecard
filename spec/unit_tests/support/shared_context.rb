...
RSpec.shared_context 'stub requests' do
  ...
  before do
    ...
    stub_request(:post, "https://checkout.wirecard.com/seamless/frontend/init").
      with(body: {"amount"=>"1000", "cancelUrl"=>"http://localhost.cancel.url", "confirmUrl"=>"http://localhost.confirm.url", "consumerIpAddress"=>"127.0.0.1", "consumerUserAgent"=>"some agent", "currency"=>"USD", "customerId"=>"D200001", "failureUrl"=>"http://localhost.failure.url", "language"=>"en", "orderDescription"=>"some description", "paymentType"=>"CCARD", "requestFingerprint"=>"c5289e611bd1b0a897717d86a5b020cf22a27015804f5dcb47697cf694208c7783c410eb3202d63ed5e5c9abb15005eb05e43dec33f7c86cf8c589c46ec55773", "requestFingerprintOrder"=>"customerId,shopId,language,currency,successUrl,failureUrl,cancelUrl,serviceUrl,confirmUrl,paymentType,storageId,amount,orderDescription,consumerIpAddress,consumerUserAgent,requestFingerprintOrder,secret", "serviceUrl"=>"http://localhost.service.url", "shopId"=>"qmore", "storageId"=>"b2737b746627482e0b024097cadb1b41", "successUrl"=>"http://localhost.success.url"},
    ...
    stub_request(:post, "https://checkout.wirecard.com/seamless/frontend/init").
      with(body: {"amount"=>"1000", "cancelUrl"=>"http://localhost.cancel.url", "confirmUrl"=>"http://localhost.confirm.url", "consumerIpAddress"=>"127.0.0.1", "consumerUserAgent"=>"some agent", "currency"=>"USD", "customerId"=>"D200001", "failureUrl"=>"http://localhost.failure.url", "language"=>"en", "orderDescription"=>"some description", "paymentType"=>"SOFORTUEBERWEISUNG", "requestFingerprint"=>"88f2ad2986e46b8801c125d1d8d62749f80f52b9942a77b262d07602adc689180b5645c37cbce7764a4ba45a2acdd2decfa572f56c95c1f595e8e3c7a2fc1341", "requestFingerprintOrder"=>"customerId,shopId,language,currency,successUrl,failureUrl,cancelUrl,serviceUrl,confirmUrl,paymentType,amount,orderDescription,consumerIpAddress,consumerUserAgent,requestFingerprintOrder,secret", "serviceUrl"=>"http://localhost.service.url", "shopId"=>"qmore", "successUrl"=>"http://localhost.success.url"},
           headers: {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Connection'=>'close', 'Content-Length'=>'813', 'Content-Type'=>'application/x-www-form-urlencoded', 'Host'=>'checkout.wirecard.com', 'User-Agent'=>'### User Agent ###'}).
    ...
    stub_request(:post, "https://checkout.wirecard.com/seamless/frontend/init").
      with(body: {"amount"=>"1000", "cancelUrl"=>"http://localhost.cancel.url", "confirmUrl"=>"http://localhost.confirm.url", "consumerIpAddress"=>"127.0.0.1", "consumerUserAgent"=>"some agent", "currency"=>"USD", "customerId"=>"D200001", "failureUrl"=>"http://localhost.failure.url", "language"=>"en", "orderDescription"=>"some description", "paymentType"=>"PAYPAL", "requestFingerprint"=>"6754a209c07d75491204229e5cf55b216e3f9bbc1ff2c3a71bde7e49e88d1b90bb371e606e0e963986aa26cf6b8f15a7e743eb791e42f46a98ecd07678ee076b", "requestFingerprintOrder"=>"customerId,shopId,language,currency,successUrl,failureUrl,cancelUrl,serviceUrl,confirmUrl,paymentType,amount,orderDescription,consumerIpAddress,consumerUserAgent,requestFingerprintOrder,secret", "serviceUrl"=>"http://localhost.service.url", "shopId"=>"qmore", "successUrl"=>"http://localhost.success.url"},
           headers: {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Connection'=>'close', 'Content-Length'=>'801', 'Content-Type'=>'application/x-www-form-urlencoded', 'Host'=>'checkout.wirecard.com', 'User-Agent'=>'### User Agent ###'}).
    ...
    stub_request(:post, "https://checkout.wirecard.com/seamless/frontend/init").
      with(body: {"amount"=>"1000", "cancelUrl"=>"http://localhost.cancel.url", "confirmUrl"=>"http://localhost.confirm.url", "consumerIpAddress"=>"127.0.0.1", "consumerUserAgent"=>"some agent", "currency"=>"USD", "customerId"=>"D200001", "failureUrl"=>"http://localhost.failure.url", "language"=>"en", "orderDescription"=>"some description", "paymentType"=>"SEPA-DD", "requestFingerprint"=>"a7ad3839afccafa12a190fb5641257e8428a7a7be0f2ceced32ad086c235f97ff19482cb0e4982fc70c4f1d6037585c9ae60edcbf3d08f877c8e4106d33f1c6c", "requestFingerprintOrder"=>"customerId,shopId,language,currency,successUrl,failureUrl,cancelUrl,serviceUrl,confirmUrl,paymentType,amount,orderDescription,consumerIpAddress,consumerUserAgent,requestFingerprintOrder,secret", "serviceUrl"=>"http://localhost.service.url", "shopId"=>"qmore", "successUrl"=>"http://localhost.success.url"},
           headers: {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Connection'=>'close', 'Content-Length'=>'802', 'Content-Type'=>'application/x-www-form-urlencoded', 'Host'=>'checkout.wirecard.com', 'User-Agent'=>'### User Agent ###'}).
